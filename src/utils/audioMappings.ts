...
export const audioMappings: AudioMapping = {
  ...
  // === CONFIRMAÇÃO - Confirmação de Intenção ===
  "Entendi. Você quer saber como cadastrar-familia. Posso continuar para o guia?":
    "confirmacao/cadastro-familia.mp3",
  "Entendi. Você quer saber como visita-domiciliar. Posso continuar para o guia?":
    "confirmacao/visita-domiciliar.mp3",
  "Entendi. Você quer saber como e-sus-problemas. Posso continuar para o guia?":
    "confirmacao/e-sus-problemas.mp3",
  "Entendi. Você quer saber como pre-natal. Posso continuar para o guia?":
    "confirmacao/pre-natal.mp3",
  "Entendi. Você quer saber como hiperdia. Posso continuar para o guia?":
    "confirmacao/hiperdia.mp3",
  "Entendi. Você quer saber como bolsa-familia. Posso continuar para o guia?":
    "confirmacao/bolsa-familia.mp3",
  "Entendi. Você quer saber como visita-recem-nascido. Posso continuar para o guia?":
    "confirmacao/visita-recem-nascido.mp3",
  "Entendi. Você quer saber como combate-dengue. Posso continuar para o guia?":
    "confirmacao/combate-dengue.mp3",
  "Entendi. Você quer saber como saude-mental. Posso continuar para o guia?":
  ...
  "Entendi. Você quer saber como saude-idoso. Posso continuar para o guia?":
    "confirmacao/saude-idoso.mp3",
  "Entendi. Você quer saber como vacinacao-atraso. Posso continuar para o guia?":
  ...
  "Entendi. Você quer saber como puerperio. Posso continuar para o guia?":
    "confirmacao/puerperio.mp3",
  "Entendi. Você quer saber como busca-ativa-tb-hanseniase. Posso continuar para o guia?":
    "confirmacao/busca-ativa-tb-hanseniase.mp3",
  "Entendi. Você quer saber como saude-bucal. Posso continuar para o guia?":
    "confirmacao/saude-bucal.mp3",
  "Entendi. Você quer saber como identificar-violencia. Posso continuar para o guia?":
  ...
  "Entendi. Você quer saber como mordedura-animais. Posso continuar para o guia?":
    "confirmacao/mordedura-animais.mp3",
  "Entendi. Você quer saber como saude-homem. Posso continuar para o guia?":
    "confirmacao/saude-homem.mp3",
  "Entendi. Você quer saber como reducao-danos. Posso continuar para o guia?":
    "confirmacao/reducao-danos.mp3",
  "Entendi. Você quer saber como prevencao-cancer. Posso continuar para o guia?":
    "confirmacao/prevencao-cancer.mp3",
  "Entendi. Você quer saber como sintomas-gripais. Posso continuar para o guia?":
    "confirmacao/sintomas-gripais.mp3",
  "Entendi. Você quer saber como desenvolvimento-infantil. Posso continuar para o guia?":
