...
const SuccessGuide = () => {
  ...
  return (
    <div className="px-6 min-h-[90vh] flex flex-col items-center justify-center gap-8 animate-in zoom-in-95 duration-500">
      ...
      <div className="bg-white border-2 border-emerald-100 p-8 rounded-[2.5rem] text-center relative overflow-hidden shadow-xl">
      ...
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <div className="w-full flex flex-col gap-3 mt-4">
          <button 
            onClick={() => navigate('/')}
            className="pill-button bg-[#1B4332] text-white w-full shadow-lg"
          >
            <Home size={20} />
        ...
        <div className="flex flex-col items-center gap-2 mt-8 opacity-40">
           ...
           <div className="text-center">
             ...
             <p className="text-[8px] text-[#1B4332] font-bold uppercase tracking-widest opacity-70">
               Governo Federal
             </p>
           </div>
        </div>
